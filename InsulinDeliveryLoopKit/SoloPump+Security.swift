...
extension SoloPump {
    var pumpKeyServiceIdentifier: String { "org.tidepool.CoastalPumpKit.Key.Shared" }
    
    private var wildcardIdentifierKey: String { "org.tidepool.CoastalPumpKit.Key.Wildcard" }
    
    private var wildcardIdentifierCertificate: String { "org.tidepool.CoastalPumpKit.Certificate.Wildcard" }
    
    private var constrainedIdentifierCertificate: String { "org.tidepool.CoastalPumpKit.Certificate.Constrained" }
